...
to setup
  ;; Creates 200 humans and moves them to a random location
  ;; Once humans are created, create 1 zombie and move them to open patch
  __clear-all-and-reset-ticks
  create-humans 200 [ set color white ]
  ask humans [move-to one-of patches with [count humans-here = 0]]

  create-zombies 1 [ set color red ]
  ask zombies [move-to one-of patches with [count humans-here = 0]]
end
